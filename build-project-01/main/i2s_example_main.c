...
#define EXAMPLE_ESP_WIFI_SSID "Home-AP"
#define EXAMPLE_ESP_WIFI_PASS "Azka1234"
...
static void setup_triangle_sine_waves(int bits)
{
    ...
    i2s_write(I2S_NUM, samples_data, (int)((bits + 8) / 16) * SAMPLE_PER_CYCLE * 4, &i2s_bytes_write, 100);
    free(samples_data);
}
...
void app_main(void)
{
    ...
    while (1)
    {
        // for (int test_bits = 16; test_bits <= 32; test_bits++)
        // {
